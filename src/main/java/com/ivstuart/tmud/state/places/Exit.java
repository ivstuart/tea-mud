...
public class Exit extends BasicThing {
    ...
    private RoomLocation destinationRoomLocation;
    private Door door;
    ...
    public Exit(String id, RoomLocation destination_) {
        this.setId(id);
        isSpecial = isSpecial(id);
        destinationRoomLocation = destination_;
    }
    ...
    public String toString() {
        return "Exit{" +
                "name=" + getName() + ","+
                "destinationRoomId='" + destinationRoomLocation + '\'' +
    ...
    public Room getDestinationRoom() {
        return World.getRoom(destinationRoomLocation);
    }
    ...
    public String look() {
        ...
        Room destinationRoom = getDestinationRoom();
