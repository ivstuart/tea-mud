...
import static com.ivstuart.tmud.state.mobs.MobCombatState.*;

public class MobStatus {

    private final Map<MobCombatState, MobStateDuration> stateMap = new HashMap<>();
    ...
    public boolean is(MobCombatState state) {
        ...
        return !removeExpiredState(state);
    }
    ...
    void removeExpiredStates() {
        ...
        stateMap.entrySet().removeIf(stateEntry -> stateEntry.getValue().isExpired());
