...
public class Disarm extends BaseCommand {
	...
	class FightActionBash extends FightAction {
		...
		public void begin() {
			...
			durationMillis(1000);
			out("<S-You prepare your/NAME prepares GEN-him>self to disarm <T-you/NAME>.");
		...
		public void happen() {
			...
			if (ability.isSuccessful()) {
				out("<S-You/NAME> successfully disarmed <T-you/NAME>.");
				...
				out("<S-You/NAME> miss<S-/es> disarming <T-you/NAME>.");
			}
