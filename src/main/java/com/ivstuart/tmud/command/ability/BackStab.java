    ...
    class FightActionBackStab extends FightAction {
        ...
        public void happen() {
            ...
            if (bsAbility.isSuccessful(getSelf())) {
                out(new Msg(getSelf(), getTarget(), ("<S-You/NAME> successfully backstab <T-you/NAME>.")));
