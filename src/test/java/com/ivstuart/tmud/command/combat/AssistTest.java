...
public class AssistTest {
    ...
    @Test
    public void testAssistWithTarget() {
        ...
        Command assist = new Assist();
        assist.execute(player2Mob, player1Mob.getAlias());
    ...
    @Test
    public void testAssistWithNoTarget() {
        ...
        Command follow = new Follow();
        follow.execute(player1Mob, player2Mob.getAlias());

        Command group = new Group();
        group.execute(player2Mob, "all");
        ...
        Command assist = new Assist();
        assist.execute(player2Mob, null);
