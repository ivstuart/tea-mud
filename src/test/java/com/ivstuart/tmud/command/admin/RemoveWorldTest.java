...
public class RemoveWorldTest {
    ...
    public void testRemoveWorld() {
        ...
        RemoveWorld removeWorld = new RemoveWorld();
        removeWorld.execute(mob, "sheep");

        assertNull("Does not exist", World.getMob("sheep"));

        assertEquals("Does match", sheepMob, mob.getPlayer().getCreated());
