...
public class GiveDiseaseTest {
    ...
    public void testGiveDisease() {
        ...
        GiveDisease giveDisease = new GiveDisease();
        giveDisease.execute(mob, "MummyRot " + bob.getAlias());

        assertEquals("Has disease", true, bob.getMobAffects().getDiseases().get(0).isDroplets());
    }
}
