...
public class WriteOnPaperTest {
    ...
    @Test
    public void testWriteOnPaper() throws MudException {
        ...
        Command write = new WriteOnPaper();
        write.execute(player1Mob, "player2 going to roll 3d6+1");

        player1Mob.getInventory().get("note").getName();
