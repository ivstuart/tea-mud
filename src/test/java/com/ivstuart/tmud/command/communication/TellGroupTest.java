...
public class TellGroupTest {
    ...
    @Test
    public void testTellGroup() throws MudException {
        ...
        follow.execute(player1Mob, player2Mob.getName());

        Command group = new Group();
        group.execute(player2Mob, "all");

        Command tellGroup = new TellGroup();
        tellGroup.execute(player1Mob, "player2 going to roll 3d6+1");
    }
