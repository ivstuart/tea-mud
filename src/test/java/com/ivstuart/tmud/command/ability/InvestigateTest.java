...
public class InvestigateTest {
    ...
    public void testInvestigate() {
        ...
        Ability ability = new Ability("investigate", 100);
        player1Mob.getLearned().add(ability);
        World.add(new BaseSkill("investigate"));
        ...
        Command investigate = new Investigate();
        investigate.execute(player1Mob, "corpse");

        // Manually check the player1 output in logs.
